export const AUTH0_DOMAIN = process.env.REACT_APP_AUTH0_DOMAIN || 'react-universal.auth0.com';
export const AUTH0_CLIENT_ID = process.env.REACT_APP_AUTH0_CLIENT_ID || '3821inroTsXub5iKOew7JHTT-OaJl3jp';
export const AUTH0_API_AUDIENCE = process.env.REACT_APP_AUTH0_API_AUDIENCE || 'https://api.react-universal.com';
